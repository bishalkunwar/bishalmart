...
export async function createProduct(name: string, image: File, formData: FormData) {
    try {
...
// export async function createProduct(formState: {name: string}, {image}: {image: string}, formData: FormData) {
//     try {
//         const name = formData.name;
//         if (!name || !image) {
//             return { message: 'Please provide a name and an image for the product' };
//         }
...
//         } else {
//             return { message: "Sorry, something went wrong, could not create the product" };
//         }
//     }
